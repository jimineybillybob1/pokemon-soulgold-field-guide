...
const CACHE_NAME = `${CACHE_PREFIX}1.1.2-20260910-r16`;
const SHELL = [
  './', './index.html', './styles.css', './refinements.css?v=1.1.2-r16', './branding.css', './app.js?v=1.1.2-r16',
  './config/game-config.js?v=1.1.2-r16', './config/game-overrides.js?v=1.1.2-r16',
  ...
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => Promise.all(SHELL.map(async path => {
        ...
        fetchUrl.searchParams.set('__precache', '1.1.2-r16');
