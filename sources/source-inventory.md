...
| Trophies and milestone rewards | https://eemeliri.github.io/soulgold/guides/achievement-rewards/ and official `src/achievements.c` | v1.1.2 tag snapshot | Official documentation and source repository | Yes | Imported all 121 active trophy names, requirements, tiers and source categories, plus the six Route 40 reward thresholds. Pokémon rewards use exact hack form keys for caught tracking. |
